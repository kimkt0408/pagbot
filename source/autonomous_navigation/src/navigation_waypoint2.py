...
class PathFollower:
    def __init__(self):
        ...
        self.MIN_HEIGHT = 0.0#-0.3
        self.NUM_POINTS_CLUSTER = 100

        self.NODE_INTERVAL = 0.4
        ...
        rospy.Subscriber('/ns1/velodyne_points', PointCloud2, self.lidarCallback)
    ...
    def lidarCallback(self, point_cloud):
        ...
        # Get the timestamp from the received PointCloud2 message
        point_cloud_time = point_cloud.header.stamp
